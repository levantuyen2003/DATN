...
@Controller
public class BepCacLoaiController {
    @Autowired
    ...
    @RequestMapping("/dogiadung/bepcacloai")
    public String getAll(Model model){
        List<DanhmucSP> danhmucSPS = danhmucSPRepo.findAll();
        List<DanhmucSP> danhmucSPs = danhmucSPService.getProductsByCategoryId(25L);
        List<Sanpham> sanpham1s = sanphamService.getProductsByCategory(12L);
        ...
        return "page/dogiadung/bepcacloai";
    }
}
